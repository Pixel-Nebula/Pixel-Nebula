    ...
    return (function(Godot) {
        ...
        function _godot_webxr_get_controller_axes(p_controller, p_xr_standard_mapping) {
            ...
            if (controller.gamepad.mapping === "xr-standard") {
                if (p_xr_standard_mapping) {
                    ...
                    axes = [axes[2], axes[3] * -1, trigger_axis, grip_axis, grip_axis, 0, axes[0], axes[1] * -1]
                } else {
                    axes[1] *= -1;
                    axes[3] *= -1
                }
        ...
        function _godot_webxr_get_controller_buttons(p_controller, p_xr_standard_mapping) {
            ...
            if (controller.gamepad.mapping === "xr-standard" && p_xr_standard_mapping) {
                buttons = [0, buttons[5], buttons[1], buttons[3], buttons[6], buttons[7], buttons[8], buttons[4], buttons[9], buttons[10], buttons[11], buttons[12], buttons[13], buttons[14], buttons[2], buttons[0]]
            }
    ...
    Config.prototype.getGodotConfig = function(cleanup) {
        ...
        return {
            ...
            'onExit': function(p_code) {
                cleanup();
                // We always need to call the cleanup callback to free memory.
